...
#define FLAG_NOIBAT_OBTAINED         0x2A
#define FLAG_NOIBAT_BERRY            0x2B
#define FLAG_DRAGON_BREATH_DISCOVERED    0x2C
...
#define FLAG_ITEM_LANETTES_HOUSE_POKEBALL      0x265
...
#define FLAG_SYS_BAG_GET                             (SYSTEM_FLAGS + 0x3) // When bag is obtained with Pichu.
