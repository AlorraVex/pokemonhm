...
const u16 gMetatiles_GeneralNew[] = INCBIN_U16("data/tilesets/primary/general_new/metatiles.bin");
const u16 gMetatileAttributes_GeneralNew[] = INCBIN_U16("data/tilesets/primary/general_new/metatile_attributes.bin");
