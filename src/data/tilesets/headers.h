...
const struct Tileset gTileset_GeneralNew =
{
    .isCompressed = TRUE,
    .isSecondary = FALSE,
    .tiles = gTilesetTiles_GeneralNew,
    .palettes = gTilesetPalettes_GeneralNew,
    .metatiles = gMetatiles_GeneralNew,
    .metatileAttributes = gMetatileAttributes_GeneralNew,
    .callback = NULL,
};
